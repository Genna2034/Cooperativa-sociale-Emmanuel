...
export const STATS = [
  ...
  },
  {
    id: 3,
    value: '15+',
    label: 'Anni di esperienza nel settore sociosanitario',
  },
  {
    id: 4,
    value: '100%',
...
export const ADI_SERVICES = [
  'Visite mediche domiciliari specialistiche',
...
// Informazioni team dirigenziale (RIMOSSA FEDERICA BORRIELLO)
export const TEAM_INFO = {
  luigiBorriello: {
    name: 'Luigi Borriello',
    role: 'Presidente e Fondatore',
    qualifications: 'Imprenditore Sociale',
    experience: '15+ anni nel settore socio-sanitario',
    specialties: ['Leadership aziendale', 'Gestione servizi socio-sanitari', 'Relazioni istituzionali']
  },
  gennaroBorriello: {
