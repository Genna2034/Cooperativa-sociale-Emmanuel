  ...
  return (
    <section className="relative pt-20 pb-24 md:pt-24 md:pb-32 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-turquoise-900/60 mix-blend-multiply" />
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          <FadeInSection direction="up" delay={200}>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 leading-tight">
              ...
              <span className="block mt-2 text-turquoise-200">
          ...
          <FadeInSection direction="up" delay={600}>
            <div className="mt-10 flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6">
              <Link
                to="/contatti"
                className="w-full md:w-auto px-8 py-4 bg-turquoise-600 hover:bg-turquoise-700 text-white rounded-full text-lg font-medium transition-colors shadow-lg"
              >
              ...
              <div className="flex flex-col gap-3 mt-6 md:mt-0">
                <div className="flex items-center gap-2">
                  <Phone className="h-5 w-5 text-turquoise-300" />
                  <a 
                ...
                <div className="flex items-center gap-2">
                  <Mail className="h-5 w-5 text-turquoise-300" />
                  <a 
